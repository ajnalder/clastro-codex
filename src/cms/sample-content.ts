...
export const plumberItems: CmsSampleItem[] = [
  ...
  },
  {
    ...
    values: {
      ...
      metaTitle: 'How to Shut Off Water in an Emergency',
      metaDescription: 'Learn how to shut off water fast, find isolation points, and reduce damage before calling a plumber.',
    },
    extraSections: [],
  },
  {
    ...
    values: {
      ...
      metaTitle: 'Hot Water Cylinder Warning Signs',
      metaDescription: 'Spot noisy valves, rusty water, pressure changes, and slow recovery before a hot water cylinder fails.',
    },
    extraSections: [],
  },
];
